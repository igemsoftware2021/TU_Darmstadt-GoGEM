...
<div id="page" class="site">
	<header id="masthead" class="site-header">
		<div class="site-branding">
			<img class="logo" src="./assets/Header.svg"/img>
		</div><!-- .site-branding -->
...
`
		...
		filelinks["./assets/Header.svg"] = "/wiki/images/7/7c/T--TU_Darmstadt--Header.svg"

		print(fh.ReplaceAllFileLinksDebug(content, filelinks))
	},
}
